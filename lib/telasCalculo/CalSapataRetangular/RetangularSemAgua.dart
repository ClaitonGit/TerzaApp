...
class CalSapataRetangularSemAgua extends StatefulWidget {
  const CalSapataRetangularSemAgua({super.key});


  @override
  State<CalSapataRetangularSemAgua> createState() => _CalSapataSemAguaState();
}

class _CalSapataSemAguaState extends State<CalSapataRetangularSemAgua> {
  ...
  void resultRetangularSemAgua(){
    ...
    setState(() {
      ...
      double ny = double.parse(nyControlle.text);
        ...
        double result = (1.1*coesao*nc)+(peso*cota*nq)+(0.9*peso*(largura/2)*ny);
        infoText = "Sapata Retangular: (${result})";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Sapata Retângular sem água"),
        centerTitle: true,
        actions: [
          IconButton(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: resultRetangularSemAgua,
                  child: Text("Calcular",
                      style: TextStyle(
                        fontSize: 20,
                        color: Colors.white,
