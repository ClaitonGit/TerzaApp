...
class CalSapataCorridaSemAgua extends StatefulWidget {
  const CalSapataCorridaSemAgua({super.key});


  @override
  State<CalSapataCorridaSemAgua> createState() => _CalSapataSemAguaState();
}

class _CalSapataSemAguaState extends State<CalSapataCorridaSemAgua> {
  ...
  void resultCorridaSemAgua(){
    ...
    setState(() {
      ...
      double ny = double.parse(nyControlle.text);
        ...
        double result = (coesao*nc)+(peso*cota*nq)+(peso*(largura/2)*ny);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Sapata Corrida sem água"),
        centerTitle: true,
        actions: [
          IconButton(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: resultCorridaSemAgua,
                  child: Text("Calcular",
                      style: TextStyle(
                        fontSize: 20,
                        color: Colors.white,
